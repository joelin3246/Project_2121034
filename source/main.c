...
/*
  ...
  以上記錄為之前延申修改記錄
      ...
      2014/07/30
    1. 修正V10A02版本，暫停後進入運動模式揚升不動作
    2. 修改暫停無揚升快鍵功能
          
      2014/08/25
    1. PCB 拿掉有關寧茂變頻器轉接板的線路
    2. 拿掉工程模式切換7700、7730的型號選項
    3. 其它功能不變

      2014/11/6
    1. I2C寫入時序對於有些IC會太快，延時時序
    2. PorgSportMode的prog表重新排序，沒有修改數值

      2014/11/19
    1. 工程模式一，增加選擇揚升校正 0 點位置的AD值
    2. 在揚升校正完成，會照工程模式一，設定的 0 點位置的AD值去記錄
    3. 開機變更程式版本顯示 1.1
